 ...
 */
@RestController
@RequestMapping("glmallcoupon/skuladder")
public class SkuLadderController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("glmallcoupon:skuladder:list")
    ...
    // @RequiresPermissions("glmallcoupon:skuladder:info")
    ...
    // @RequiresPermissions("glmallcoupon:skuladder:update")
    ...
    // @RequiresPermissions("glmallcoupon:skuladder:delete")
